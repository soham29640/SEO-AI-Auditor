...
tfidf = TfidfVectorizer(
    max_features=5000,              # allow more SEO terms
    ngram_range=(1, 2),             # 1-2 grams usually best for SEO
    stop_words="english",           # remove common words
    sublinear_tf=True, 
    lowercase=True,
    min_df=2,                       # ignore very rare terms
    max_df=0.85,                    # ignore overly common terms
    token_pattern=r"(?u)\b[a-zA-Z][a-zA-Z]+\b"  # remove numbers/single chars
)
...
top_keywords = get_top_keywords(0, 50)
